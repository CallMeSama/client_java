 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "http://localhost/actu_site/soap_server.php", wsdlLocation = "http://localhost/actu_site/server.wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("http://localhost/actu_site/soap_server.php", "UserService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost/actu_site/server.wsdl");
    ...
    public UserServicePortType getUserServicePort() {
        return super.getPort(new QName("http://localhost/actu_site/soap_server.php", "UserServicePort"), UserServicePortType.class);
    }
    ...
    public UserServicePortType getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://localhost/actu_site/soap_server.php", "UserServicePort"), UserServicePortType.class, features);
    }
